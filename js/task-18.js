...
let totalPrice = pricePerDroid * orderedQuantity;
  totalPrice <= customerCredits ? message = `Вы купили ${orderedQuantity} дроидов, на счету осталось ${customerCredits - totalPrice} кредитов` : message = `Недостаточно средств на счету!`;
